...
public class TelaPrincipal {
    ...
    public TelaPrincipal() {
        ...
        botaoCadastro.addActionListener(actionListener -> {
            TelaCadastrar telaCadastrar = new TelaCadastrar(this);
            telaCadastrar.abrirTela();
            fecharTela();
        });
        ...
        botaoLogar.addActionListener(actionListener -> {
            TelaLogar telaLogar = new TelaLogar(this);
            telaLogar.abrirTela();
            fecharTela();
        });
        ...
        botaoAdmin.addActionListener(actionListener -> {
